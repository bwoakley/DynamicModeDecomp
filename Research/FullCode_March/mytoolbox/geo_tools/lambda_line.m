...
etaPos(:,1) = real(sqrt((l2 - lambda^2)./(l2 - l1)).*xi1(:,1) + sqrt((lambda^2 - l1)./(l2 - l1)).*xi2(:,1));
etaPos(:,2) = real(sqrt((l2 - lambda^2)./(l2 - l1)).*xi1(:,2) + sqrt((lambda^2 - l1)./(l2 - l1)).*xi2(:,2));

etaNeg(:,1) = real(sqrt((l2 - lambda^2)./(l2 - l1)).*xi1(:,1) - sqrt((lambda^2 - l1)./(l2 - l1)).*xi2(:,1));
etaNeg(:,2) = real(sqrt((l2 - lambda^2)./(l2 - l1)).*xi1(:,2) - sqrt((lambda^2 - l1)./(l2 - l1)).*xi2(:,2));
